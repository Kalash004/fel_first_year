...
V souborech program-x86.list, program-riscv.list a program-mips.list
naleznete výpis programu z paměti počítače.
...
zkompilovaný překladačem pro 32-bitovou varianu procesoru s architekturou
RISC-V a big-endian variantu architektury MIPS32.
...
program-riscv.list - výpis paměti ze systému s architekturou RISC-V,
...
Files program-x86.list, program-riscv.list and program-mips.list
are dump/listing of a program obtained from a computer memory.

Program has been compiled using C compiler for x86 32-bit
computer and OS GNU/Linux first. Then the same code has
been compiled for 32-bit RISC-V based system and big-endian
variant of MIPS32 architecture.
...
The remaining algorithm parts required to fulfill equivalent
...
program-riscv.list - dump of computer/process memory for RISC-V
